...
def main():
    ...
    parser.add_argument('--rates', type=str, default='0.0,0.05,0.1,0.2,0.3', help='Comma-separated hardening rates')
    parser.add_argument('--thresholds', type=str, default='0.50,0.55,0.60,0.65', help='Comma-separated hardening thresholds')
    ...
    if args.ab_check:
        quick_ab(seed=seeds[0] if seeds else 0, epochs_per_phase=args.epochs_per_phase)
    else:
        run_hardening_sweep(
            rates=rates,
