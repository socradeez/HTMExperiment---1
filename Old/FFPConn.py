...
class FFProximalConnection:
    ...
    def __init__(self, parent_layer, input_layer, connected_perm=0.5, initial_perm_range=0.3, boost_strength=1, stim_threshold=3):
